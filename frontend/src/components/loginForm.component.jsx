...
import { fetchUser, loginFailure, loginRequest, loginSuccess } from "../action/userActions"
...
export default function LoginForm() {
    ...
    const onSubmit = data => {
        ...
        fetchUser(data.username, data.password)
            .then(response => readAuthResponse(response))
